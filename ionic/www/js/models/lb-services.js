  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Company.contratcts.findById() instead.
        "prototype$__findById__contratcts": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/companies/:id/contratcts/:fk",
          method: "GET"
        },

        // INTERNAL. Use Company.contratcts.destroyById() instead.
        "prototype$__destroyById__contratcts": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/companies/:id/contratcts/:fk",
        ...
        // INTERNAL. Use Company.contratcts.updateById() instead.
        "prototype$__updateById__contratcts": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/companies/:id/contratcts/:fk",
        ...
        // INTERNAL. Use Company.contratcts() instead.
        "prototype$__get__contratcts": {
          isArray: true,
          url: urlBase + "/companies/:id/contratcts",
          method: "GET"
        },

        // INTERNAL. Use Company.contratcts.create() instead.
        "prototype$__create__contratcts": {
          url: urlBase + "/companies/:id/contratcts",
          method: "POST"
        },

        // INTERNAL. Use Company.contratcts.destroyAll() instead.
        "prototype$__delete__contratcts": {
          url: urlBase + "/companies/:id/contratcts",
          method: "DELETE"
        },

        // INTERNAL. Use Company.contratcts.count() instead.
        "prototype$__count__contratcts": {
          url: urlBase + "/companies/:id/contratcts/count",
          method: "GET"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Company.contratcts
     * @header lbServices.Company.contratcts
     * @object
     * @description
     *
     * The object `Company.contratcts` groups methods
     * manipulating `Contract` instances related to `Company`.
     *
     * Call {@link lbServices.Company#contratcts Company.contratcts()}
     ...
     */
         ...
         * </em>
         */
        R.contratcts = function() {
          var TargetResource = $injector.get("Contract");
          var action = TargetResource["::get::company::contratcts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Company.contratcts#count
         * @methodOf lbServices.Company.contratcts
         *
         * @description
         *
         * Counts contratcts of company.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         *  - `count` – `{number=}` - 
         */
        R.contratcts.count = function() {
          var TargetResource = $injector.get("Contract");
          var action = TargetResource["::count::company::contratcts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Company.contratcts#create
         * @methodOf lbServices.Company.contratcts
         *
         * @description
         *
         * Creates a new instance in contratcts of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.contratcts.create = function() {
          var TargetResource = $injector.get("Contract");
          var action = TargetResource["::create::company::contratcts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Company.contratcts#createMany
         * @methodOf lbServices.Company.contratcts
         *
         * @description
         *
         ...
         * </em>
         */
        R.contratcts.createMany = function() {
          var TargetResource = $injector.get("Contract");
          var action = TargetResource["::createMany::company::contratcts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Company.contratcts#destroyAll
         * @methodOf lbServices.Company.contratcts
         *
         * @description
         *
         * Deletes all contratcts of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * This method returns no data.
         */
        R.contratcts.destroyAll = function() {
          var TargetResource = $injector.get("Contract");
          var action = TargetResource["::delete::company::contratcts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Company.contratcts#destroyById
         * @methodOf lbServices.Company.contratcts
         *
         * @description
         *
         * Delete a related item by id for contratcts.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         *
         *  - `fk` – `{*}` - Foreign key for contratcts
         *
         * @param {function(Object,Object)=} successCb
         *   Success callback with two arguments: `value`, `responseHeaders`.
         *
         ...
         * This method returns no data.
         */
        R.contratcts.destroyById = function() {
          var TargetResource = $injector.get("Contract");
          var action = TargetResource["::destroyById::company::contratcts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Company.contratcts#findById
         * @methodOf lbServices.Company.contratcts
         *
         * @description
         *
         * Find a related item by id for contratcts.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.contratcts.findById = function() {
          var TargetResource = $injector.get("Contract");
          var action = TargetResource["::findById::company::contratcts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Company.contratcts#updateById
         * @methodOf lbServices.Company.contratcts
         *
         * @description
         *
         * Update a related item by id for contratcts.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.contratcts.updateById = function() {
          var TargetResource = $injector.get("Contract");
          var action = TargetResource["::updateById::company::contratcts"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Company.contratcts.destroyById() instead.
        "::destroyById::company::contratcts": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/companies/:id/contratcts/:fk",
        ...
        // INTERNAL. Use Company.contratcts.create() instead.
        "::create::company::contratcts": {
          url: urlBase + "/companies/:id/contratcts",
          method: "POST"
        },

        // INTERNAL. Use Company.contratcts.createMany() instead.
        "::createMany::company::contratcts": {
          isArray: true,
          url: urlBase + "/companies/:id/contratcts",
          method: "POST"
        },
        ...
        // INTERNAL. Use Company.contratcts.destroyAll() instead.
        "::delete::company::contratcts": {
          url: urlBase + "/companies/:id/contratcts",
          method: "DELETE"
        },

        // INTERNAL. Use Company.contratcts.count() instead.
        "::count::company::contratcts": {
          url: urlBase + "/companies/:id/contratcts/count",
          method: "GET"
        },
      }
